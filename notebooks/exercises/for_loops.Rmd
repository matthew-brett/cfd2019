...
<meta property="og:url" content="https://matthew-brett.github.io/cfd2019/notebooks/exercises/for_loops.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/cfd2019/notebooks/exercises/for_loops.Rmd">
...
This for loop is meant to print out the numbers from 0 through 5, but it isn't
right yet.  Fix:
...
This for loop is meant to print out the numbers fro 2 through 5, but it
isn't right yet.  Fix:
...
This for loop is meant to print out the numbers from -5 through 4, but it
does not work as it should.  Fix:

```{python}
for my_var in range(-5, 5):
    print(i)
```

This for loop is meant to print out the numbers from 10 through 15, but it gives an error.  See if you can spot the problem.  Fix:
...
This for loop is meant to print out the numbers from 10 through 25, in steps of 5, but it gives an error.  See if you can spot the problem.  Fix:
