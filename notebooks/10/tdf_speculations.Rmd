...
<meta property="og:url" content="https://matthew-brett.github.io/cfd2019/notebooks/10/tdf_speculations.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/cfd2019/notebooks/10/tdf_speculations.Rmd">
...
```{python}
df = pd.read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2020/2020-04-07/stage_data.csv')
df.head()
```
...
```{python}
one_stage = df[(df['year'] == 2015) & (df['stage_results_id'] == 'stage-1')]
one_stage.head()
```
...
```{python}
big_epa_cars = pd.read_csv("https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2019/2019-10-15/big_epa_cars.csv")
big_epa_cars.head()
```
