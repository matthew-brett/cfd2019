...
<!-- begin _includes/seo.html --><title>Background reading - Coding for Data - 2019 edition</title>
...
<meta property="og:url" content="https://matthew-brett.github.io/cfd2019/notebooks/10/bayes_confidence.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/cfd2019/notebooks/10/bayes_confidence.Rmd">
...
After a bit of development, we found, in the [reverse probability with bars](/cfd2019/chapters/10/bayes_bars) page, that we could use some
...
You can download the 2018 marks from [havana_math_2018.csv](/cfd2019/data/havana_math_2018.csv).
...
You can download the sample file from [havana_math_2019_sample.csv](/cfd2019/data/havana_math_2019_sample.csv).
...
As we saw in the page on [using minimize](/cfd2019/chapters/08/using_minimize#unpacking), we can get this value a little more
...
Look back at [where and argmin](/cfd2019/chapters/08/where_and_argmin) for the trick here of using `np.where` to find
the index.
...
To do this, we follow the rules in [reverse probability](/cfd2019/chapters/10/first_bayes) and [Bayes bars](/cfd2019/chapters/10/bayes_bars).
...
* As you saw in [reverse probability](/cfd2019/chapters/10/first_bayes) and [Bayes bars](/cfd2019/chapters/10/bayes_bars), when all the prior (initial) probabilities are
...
[arrays](/cfd2019/chapters/03/Arrays) page. It takes an input array
...
Enter the [bootstrap](/cfd2019/chapters/10/bootstrap).
