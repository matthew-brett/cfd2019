...
90, as it was in 2017.  Or we might wonder whether we could be say that the
eventual median for all the papers will be the sample median 92, plus or minus
a bit.   If so, what value should we give to "a bit".

This kind of problem can be called a problem of *reverse probability*.  We
have observed some outcome from our sample -- 92 -- and we want to be able to
say something about the *population* from which the sample came -- in our
case, the population of all 13000 or so exam marks.
