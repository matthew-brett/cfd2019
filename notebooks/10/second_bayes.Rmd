...
The [Bayes bars page](/cfd2019/chapters/10/bayes_bars) has a way of thinking of our calculations for this game, using the height of bars to express our probabilities.
...
We can solve this by simulation, of course, but lets solve it using the bars from the [Bayes bars page](/cfd2019/chapters/10/bayes_bars).
