...
The mean here is about 54.5.  That seems a bit lower than the 2018 mean ---
but have I been deceived by the sample?  Was I just unlucky?   How confident
can I be that the mean from the full results will in fact be near 54.5, rather
than the 65.3 or so of the previous year?


We now enter the territory of *confidence intervals*.

My question is: how close is my *sample mean* of 54.5 likely to be to the
eventual mean, once I have all 8000 or so results for 2019?  How *confident*
can I be in this sample mean of around 54.5?
