...
<meta property="og:url" content="https://matthew-brett.github.io/cfd2019/notebooks/08/mean_meaning.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/cfd2019/notebooks/08/mean_meaning.Rmd">
...
The dataset is [gender_stats.csv](/cfd2019/data/gender_stats.csv).
This contains some World Bank statistics for each country on health and
economic factors related to gender equality. See [the data file page](/cfd2019/data/gender_stats) for more detail.
...
algebra](../extra/mean_sq_deviation) to show this, but the *mean* has to give
