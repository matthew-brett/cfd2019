...
What if we wanted to select the rows that were between the 25% and 75%
quantile?  Here's how to get the quantile value.
...
```{python}
# Select values above the 25% quantile.
...
```{python}
# True if Easiness is above 25% quantile.
...
```{python}
# True if Easiness is below 75% quantile.
...
above the 25% quantile, and below the 75% quantile.
...
the 75% quantile or below the 25% quantile:
