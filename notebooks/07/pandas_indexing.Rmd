...
This is the [gender_stats.csv]({{ site.baseurl }}/data/gender_stats.csv) file.  See [the gender stats data page](https://github.com/matthew-brett/datasets/tree/master/gender_stats) for some more detail.
