...
Consider the following annoying situation.  You can download the data file from [imdblet_latin1.csv](/cfd2019/data/imdblet_latin1.csv).

```{python tags=c("raises-exception")}
films = pd.read_csv('imdblet_latin1.csv')
```
