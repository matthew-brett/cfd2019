...
byte is a binary number with 8 binary digits, so it can store $2^8$ different
values.
...
outside the standard English alphabet.  Here's the surname of [Ferenado
...
It's a mess - because UTF-8 doesn't know what to interpret bytes that Latin 1
wrote --- this sequence of bytes doesn't make sense in the UTF-8 encoding.
