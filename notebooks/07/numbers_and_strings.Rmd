...
When we `apply` a function to a Series, it takes each value from the Series, calls the function, and returns the value.  Recall that the `float` function converts the thing you pass into a floating point value:
